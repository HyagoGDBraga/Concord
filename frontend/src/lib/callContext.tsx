...
export function CallProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    api
      ...
      .catch(() => {});
    // user?.id e NAO user, deliberadamente. O objeto muda de identidade a cada
    // atualizacao de sessao; depender dele fazia este efeito rodar de novo e
    // encerrar a chamada que tinha acabado de comecar. O aviso do lint esta
    // errado neste caso especifico.
