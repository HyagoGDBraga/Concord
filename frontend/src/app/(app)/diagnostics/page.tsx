 ...
 *
 * Prova visualmente que a cadeia inteira esta ligada: navegador -> Caddy ->
 * Spring Boot -> PostgreSQL. Na Fase 1 era a pagina inicial; a partir da Fase 2
 * vive dentro da area autenticada, em /diagnostics.
 *
