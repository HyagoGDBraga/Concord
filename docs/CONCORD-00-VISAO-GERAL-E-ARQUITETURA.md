...
> **Nota sobre "bloquear":** o verbo aparece em dois lugares do produto e significa coisas diferentes. `DISABLED` é o admin impedindo uma conta de operar. `blocks` (Fase 3) é um usuário recusando contato de outro. São mecanismos independentes; a interface precisa usar palavras diferentes para eles.
